...
#3. Part B Audit: Application Resources & Actions
Everything the app stores these will become your API's resources

1. Artisan’s details
2. Customer Login Details
3. Artisans’ login Details
4. Contact Details
5. Pricing Details
6. Booking Details
7. Training Courses
   Every action a user can take on those things (create, view, edit, delete, mark complete, search, filter, etc.)
8. Create Account
9. View artisan profile
10. Loggin
11. Booking
12. Choosing a plan
13. Enrolling as an artisan
14. Upgrading a plan

#Ring Position - Team 3
Consuming From Team 2
Creating for Team 4
